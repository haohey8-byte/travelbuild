...
@Module({
  ...
  imports: [AuthModule],
  controllers: [RoutesController, CostInquiryController, H5Controller, OgPageController, RouteArchiveController],
  providers: [RoutesService, CostInquiryService, RouteArchiveService],
})
