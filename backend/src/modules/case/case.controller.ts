...
// 三角色共创 / 角色自发布：pandaking 全量；agency 管理归属自己机构的案例；
// provincial 管理自己创建的案例；派生案例归创建人（agencyId 取创建人机构）
